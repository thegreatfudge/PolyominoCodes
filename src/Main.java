...
//
        ...
        toEncode.add(polyomino3);
        Polyomino encoded = PolyominoCode.encodeCode(toEncode);
...
//        //System.out.println(mapTest1.equals(mapTest2));
        List<Polyomino> decoded = new LinkedList<>();
        System.out.println(PolyominoCode.checkIfSetIsCode(test));
//        System.out.println(PolyominoCode.decodeCode(encoded, test, decoded, 0, false));
//        System.out.println(decoded);
//
//
//        Set<Monomino> listOfMonominosX = new HashSet<>();
//        listOfMonominosX.add(new Monomino(new Point(0,0),"a",true,false));
//        listOfMonominosX.add(new Monomino(new Point(0,1), "", false, true));
//        System.out.println(listOfMonominosX.contains(new Monomino(new Point(0,1),"",false,true)));
    }
}
